  ...
  return (
    <div>
      ...
      <div className="invoice-review-note">
        <p>
          To create a new invoice, go to{" "}
          <a href="/dashboard/purchase_orders">Purchase Orders</a> and add the
          invoice directly to the purchase order by clicking the link on the
          table
        </p>
      </div>
          ...
          <TableBody>
            {invoices.map((invoice) => (
              <StyledTableRow key={invoice.id}>
                ...
                <StyledTableCell align="right">
                  {invoice.paid ? "Payment made" : "Awaiting payment"}
                </StyledTableCell>
                <StyledTableCell align="right">
